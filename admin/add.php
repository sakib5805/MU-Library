...
<head>
	...
	<style type="text/css">
		...
		body {
  background: rgb(49,71,186);
background: radial-gradient(circle, rgba(49,71,186,1) 0%, rgba(173,29,59,1) 100%);
...
function closeNav() {
  ...
  document.body.style.backgroundColor = "#ad1d3b";
}
</script>
